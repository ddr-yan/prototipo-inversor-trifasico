clear; clc; close all;
syms t tau ie(t) Rgloff_eq Vplt Ciss Vdrv Vbe3 B1 B2 Rc Rb ie2 Qgd t_off tsw Vb Vf

% ---- Definir ecuación de descarga del capacitor

eqn = (Vdrv-Vf)-(1/Ciss)*int(ie(tau), tau, 0, t) == + ie(t)*(Rgloff_eq) + Vbe3+Vb;
...
sol_num2 = subs(valorRgloff_eq, ...
    [B2,      tsw,      Ciss,     Rc,     Vplt,     Vbe3,     Vdrv,     Qgd     , Vb, Vf], ...
    [B2_val,  tsw_val,  Ciss_val, Rc_val, Vplt_val, Vbe3_val, Vdrv_val  Qgd_val,  Vb_val,  Vf_val]);
...
sol_num1 = subs(ton, ...
    [B2,      tsw,      Ciss,     Rc,     Vplt,     Vbe3,     Vdrv,     Qgd,     Rgloff_eq,     Vb,  Vf], ...
    [B2_val,  tsw_val,  Ciss_val, Rc_val, Vplt_val, Vbe3_val, Vdrv_val  Qgd_val, Rgloff_eq_val ,Vb_val, Vf_val]);

ton_val=double (sol_num1);

sol_num1 = subs(tpo, ...
    [B2,          Ciss,     Rc,     Vplt,     Vbe3,     Vdrv,     Qgd,     Rgloff_eq,     Vb, Vf], ...
    [B2_val,  Ciss_val, Rc_val, Vplt_val, Vbe3_val, Vdrv_val  Qgd_val, Rgloff_eq_val ,Vb_val, Vf_val]);
